...
#if defined(JOY_SHOCK_INTERNAL)
#define JOY_SHOCK_API
#elif _MSC_VER && defined(JOY_SHOCK_EXPORTS)
#define JOY_SHOCK_API __declspec(dllexport)
#elif _MSC_VER
#define JOY_SHOCK_API __declspec(dllimport)
#else
#define JOY_SHOCK_API
#endif
